...
function Porsche(){
        return(
            <div className="container-fluid" id="porsche-container">
                ...
                <img src="../../src/Pics/Cars/museum.jpg" alt="Porche Musseum"  width="50%" className="img-fluid"/>
                    ...
                    <img src="../../src/Pics/Cars/911.jpg" alt="911 latest" width="40%" className="img-fluid"/>
                    <img src="../../src/Pics/Cars/911then.jpg" alt="911 first" width="40%" className="img-fluid" />
